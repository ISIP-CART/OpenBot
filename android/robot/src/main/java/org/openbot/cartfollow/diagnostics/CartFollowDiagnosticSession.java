        ...
        () -> {
          try {
            ...
            json.put("session_id", sessionId)
                ...
                .put("initialization_continuity", "confirmed-track-continuity-v1")
                .put("initialization_gallery", "post-positioning-exact-track-v1")
                .put("identity_permission_events", "transition-events-v1")
